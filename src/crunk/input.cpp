...
internal inline v2 get_mouse_drag_delta() {
    v2 result;
...
internal inline v2 get_mouse_delta() {
    v2 result; 
...
internal inline v2 mouse_position() {
    v2 result;
...
internal void input_begin(OS_Handle window_handle, OS_Event_List *events) {
    ...
    g_input.client_dim = v2s32((s32)window_dim.x, (s32)window_dim.y);
...
internal void input_end(OS_Handle window_handle) {
    v2 window_dim = os_get_window_dim(window_handle);
    v2_s32 client_dim = v2s32((s32)window_dim.x, (s32)window_dim.y);
    ...
    if (os_window_is_focused(window_handle)) {
        v2_s32 center = v2s32(client_dim.x / 2, client_dim.y / 2);
