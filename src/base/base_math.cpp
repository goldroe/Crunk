...
inline internal v4 linear_combine_v4_m4(v4 left, m4 right) {
    v4 result;
...
inline internal m4 mul_m4(m4 left, m4 right) {
    m4 result;
    result.columns[0] = linear_combine_v4_m4(right.columns[0], left);
    result.columns[1] = linear_combine_v4_m4(right.columns[1], left);
    result.columns[2] = linear_combine_v4_m4(right.columns[2], left);
    result.columns[3] = linear_combine_v4_m4(right.columns[3], left);
    return result;
}
...
inline internal m4 ortho_rh_zo(f32 left, f32 right, f32 bottom, f32 top, f32 _near, f32 _far) {
    m4 result = identity_m4();
...
inline internal m4 perspective_projection_rh(f32 fov, f32 aspect_ratio, f32 _near, f32 _far) {
    m4 result = identity_m4();
...
inline internal v2 floor_v2(v2 v) {
    v2 result;
    result.x = floorf(v.x);
    result.y = floorf(v.y);
    return result;
...
inline internal v3 floor_v3(v3 v) {
    v3 result;
    result.x = floorf(v.x);
    result.y = floorf(v.y);
    result.z = floorf(v.z);
...
inline internal v4 floor_v4(v4 v) {
    v4 result;
    result.x = floorf(v.x);
    result.y = floorf(v.y);
    result.z = floorf(v.z);
...
inline internal f32 angle_from_vector(v2 v) {
    f32 result = atan2f(v.y, v.x);
    return result;
}

inline internal v2 direction_from_angle(f32 angle) {
    v2 result;
    result.x = cosf(angle);
    result.y = sinf(angle);
    return result;
...
inline internal v2 normalize_v2(v2 v) {
    ...
    result = (length == 0.f) ? v2_zero() : div_v2_s(v, length);
    return result;
}
...
inline internal v3 normalize_v3(v3 v) {
    ...
    result = (length == 0.f) ? v3_zero() : div_v3_s(v, length);
    return result;
}
...
inline internal v4 normalize_v4(v4 v) {
    ...
    result = (length == 0.f) ? v4_zero() : div_v4_s(v, length);
    return result;
}
...
#ifdef __cplusplus
inline internal v4 mul(m4 m, v4 v) {v4 result = mul_m4_v4(m, v); return result;}
inline internal m4 mul(m4 a, m4 b) {m4 result = mul_m4(a, b); return result;}

inline internal v2 normalize(v2 v) {v2 result = normalize_v2(v); return result;}
inline internal v3 normalize(v3 v) {v3 result = normalize_v3(v); return result;}
inline internal v4 normalize(v4 v) {v4 result = normalize_v4(v); return result;}

inline internal f32 dot(v2 a, v2 b) {f32 result = dot_v2(a, b); return result;}
inline internal f32 dot(v3 a, v3 b) {f32 result = dot_v3(a, b); return result;}
inline internal f32 dot(v4 a, v4 b) {f32 result = dot_v4(a, b); return result;}

inline internal f32 length(v2 v) {f32 result = length_v2(v); return result;}
inline internal f32 length(v3 v) {f32 result = length_v3(v); return result;}
inline internal f32 length(v4 v) {f32 result = length_v4(v); return result;}

inline internal f32 length2(v2 v) {f32 result = length2_v2(v); return result;}
inline internal f32 length2(v3 v) {f32 result = length2_v3(v); return result;}
inline internal f32 length2(v4 v) {f32 result = length2_v4(v); return result;}

inline internal v2 lerp(v2 a, v2 b, f32 t) {v2 result = lerp_v2(a, b, t); return result;}
inline internal v3 lerp(v3 a, v3 b, f32 t) {v3 result = lerp_v3(a, b, t); return result;}
inline internal v4 lerp(v4 a, v4 b, f32 t) {v4 result = lerp_v4(a, b, t); return result;}

inline internal v3 cross(v3 a, v3 b) {v3 result = cross_v3(a, b); return result;}
#endif // __cplusplus
